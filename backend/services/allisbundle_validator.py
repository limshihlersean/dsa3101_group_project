...
def validate_allisbundle_data(data):
    if (not check_json_keys(data, {"company","age", "is_citizen", "events", "price", "singleA","singleB","singleC","singleD","singleE"})):
    ...
    return company, age, is_citizen, events, price, singleA, singleB, singleC, singleD, singleE